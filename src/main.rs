...
fn main() {
    ...
    // Resolve foliage_root: prefer level file value, fall back to landscape.toml.
    let foliage_root_str = terrain_source
        .foliage_root
        .clone()
        .or_else(|| app_config::load().source.foliage_root);
